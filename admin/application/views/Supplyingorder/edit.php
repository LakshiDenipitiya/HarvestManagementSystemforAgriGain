  ...
  <div class = "row">
    ...
    <div class= "col-md-3 col-md-offset-0"> 
              ...
              <select class="form-control" name="supplier_id" id="supplier_id">
                <?php
                            foreach($supplierDbList as $llst){
                              if($llst->id==$so_datails->supplier_id){
                            ?>
                ...
                <div class = "row">
                    ...
                    <div class= "col-md-3"> 
                       <select class="form-control" name="location" id="location_id">
                            <?php 
                            foreach($locationsDbList as $llst){
...
$attributes = ['id' => 'myform'];
 echo form_open("Supplyingorder/updatesupplyingorder", $attributes)?>
    ...
    <input type="hidden" name="supplierid" id="supplierid" value="<?php echo $so_datails->supplier_id;?>"> 
