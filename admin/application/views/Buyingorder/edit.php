  ...
  <div class = "row">
    ...
    <div class= "col-md-3 col-md-offset-0"> 
           <select class="form-control" name="buyer_id" id="buyer_id">
                            ...
                            foreach($buyerDbList as $llst){
                              if($llst->id==$bo_datails->buyer_id){
                            ?>
                            <option selected="selected" value="<?php echo $llst->id;?>"><?php echo $llst->firstname." ".$llst->lastname;?></option>
                            <?php
                              }else{
                            ?>
                            <option value="<?php echo $llst->id;?>"><?php echo $llst->firstname." ".$llst->lastname;?></option>
                            <?php
                              }  
                            }
                            ?>
...
$attributes = ['id' => 'myform'];
 echo form_open("Buyingorder/updatebuyingorder", $attributes)?>
    <input type="hidden" name="boid" value="<?php echo $bo_datails->bo_id;?>">
    <input type="hidden" name="buyerid" id="buyerid" value="<?php echo $bo_datails->buyer_id;?>"> 
