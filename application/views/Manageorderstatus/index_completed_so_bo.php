           ...
           <div class="table table-responsive">
                ...
                <table class="table table-bordered table-striped table-hover dataTable" id="buyingorder">
                    ...
                    <tbody>
                        ...
                        <?php if($readytodistpatch_so_bo){
                        foreach ($readytodistpatch_so_bo as $key => $buyingorder) { ?>
                        <tr>
                            ...
                            <td>
                                            <?php echo anchor("Manageorderstatus/generate_so_duepayment_invoice_list/" . $buyingorder->so_id."/".$buyingorder->location_id, '<span class="fa fa-edit"> Generate Invoice</span>', (array('class' => 'btn btn-xs btn-success '))) ?> 
                             </td>
