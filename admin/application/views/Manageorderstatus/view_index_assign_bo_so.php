...
<section class="content">
	...
	<div class="box box-default">
		...
		<div class="box-header with-border"><h3 align="center" class="box-title"> <h3 class="box-title"> <a href="<?php echo base_url() ?>/Manageorderstatus/create_advance_payment/">
