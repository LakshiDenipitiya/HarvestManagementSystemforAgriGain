...
<section class="content-header">
	<h1>
		Assign Agriculture Officer to buying supplying order<small>create</small>
	</h1>
...
<section class="content">
	...
	<div class="box box-default">
		...
		<div class="box-header with-border"><h3 align="center" class="box-title">Assign Agriculture Officer to buying supplying order Form</h3>
		...
		<div class="box-body">
			...
			<?php echo form_open("Manageorderstatus/save")?>

			<!--location input feild-->
				<div class = "row">
					<input type="hidden" name="boid" id="boid" value="<?php echo $boid;?>">
...
<script type="text/javascript">
	$(function(){
      ...
      function checkdates(chkdate,boid){
         $.ajax({
                                type: 'POST',
                                url:"<?php echo base_url('/manageorderstatus/check_dates');?>",
                                dataType: 'json',
                                //getbuyer by id
                                data:{'chkdate':chkdate,'boid':boid},
