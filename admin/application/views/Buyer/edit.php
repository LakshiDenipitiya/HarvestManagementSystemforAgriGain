...
<section class="content">
    ...
    <div class="box box-default">
        ...
        <div class="box-header with-border"><h3 align="center" class="box-title">Edit Buyer</h3>
        ...
        <div class="box-body">
            ...
            <?php echo form_open('Buyer/update/'.$selectedUser->id) ?>
    ...
    <div class = "row">
            ...
            <div class= "col-md-4 col-md-offset-0"> 
                                        <?php 
                                            ...
                                            echo form_multiselect ('item_i_id[]',$itemList,$buyer_item_id_list,$data);
