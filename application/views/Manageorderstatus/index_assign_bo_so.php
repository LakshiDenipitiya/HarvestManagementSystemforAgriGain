...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <h3 class="box-title">Buyer agreed - Ready to Advance Payment</h3>
                ...
                <table class="table table-bordered table-striped table-hover" id="buyingorder">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                            <?php echo anchor("Manageorderstatus/generate_advance_invoice/" . $buyingorder->bo_id, '<span class="fa fa-edit"> Generate Advance Payment Invoice</span>', (array('class' => 'btn btn-xs btn-success '))) ?> 
                             </td>
                             <td>
                                             <?php echo anchor("Manageorderstatus/viewconsentedorder/" . $buyingorder->bo_id, '<span class="fa fa-eye"> View</span>', (array('class' => 'btn btn-xs btn-info '))) ?> 
                                        </td>
                                    </tr>
