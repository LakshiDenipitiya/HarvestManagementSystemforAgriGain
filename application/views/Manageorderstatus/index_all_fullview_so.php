                        ...
                        <tr>
                          ...
                          <!--  <td><?php echo $buyingorder->firstname.'&nbsp;'.$buyingorder->lastname; ?></td> -->
                            ...
                            <td>  <?php if($buyingorder->bs_stts==1){
                                ...
                                ?></td>
                                                    <td>
                                             <?php echo anchor("Manageorderstatus/viewbuyingorderstatus/" . $buyingorder->so_id, '<span class="fa fa-eye"> View</span>', (array('class' => 'btn btn-xs btn-info '))) ?> 

                                               <?php if($this->session->userdata('type')=="buyer"){
                                                           if($buyingorder->bs_stts==3){
                                                                echo anchor("Manageorderstatus/generate_due_payment_invoice/" . $buyingorder->so_id, '<span class="fa fa-edit"> Generate Due Payment</span>', (array('class' => 'btn btn-xs btn-success ')));
                                                           }else{
                                                echo anchor("Manageorderstatus/create_advance_payment/" . $buyingorder->so_id, '<span class="fa fa-edit"> Proceed</span>', (array('class' => 'btn btn-xs btn-success ')));
                                                    }} ?>
