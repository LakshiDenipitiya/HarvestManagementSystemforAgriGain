...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'agrigain_logo.jpg')) {
		$tcpdf_header_logo = 'agrigain_logo.jpg';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Best Online Platform for Harvest Trade');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Branches - Colombo, Monaragla, Anuradhapura\nContact - 0112976348\n");
}
