...
class Item_Model extends CI_Model {
    ...
    function getAllbybuyer(){
        $this->db->where('buyeritem.buyer_id',$this->session->userdata('employee_id'));
      ...
      function getAllbysupplier(){
        $this->db->where('supplieritem.supplier_id',$this->session->userdata('employee_id'));
