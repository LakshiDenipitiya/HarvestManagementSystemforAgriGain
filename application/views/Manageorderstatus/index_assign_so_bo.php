...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <h3 class="box-title">Supplier agreed - Ready to Advance Payment</h3>
           ...
           <div class="table table-responsive">
                ...
                <table class="table table-bordered table-striped table-hover" id="buyingorder">
                    ...
                    <tbody>
                        <?php foreach ($done_so as $key => $supplyingorder) { ?>
                        <tr>
                            ...
                            <td>
                                            <?php echo anchor("Manageorderstatus/generate_so_advance_invoice_view/" . $supplyingorder->so_id, '<span class="fa fa-edit"> View Advance Invoice</span>', (array('class' => 'btn btn-xs btn-success '))) ?> 
                                             <?php echo anchor("Manageorderstatus/viewsoconsentedorder/" . $supplyingorder->so_id, '<span class="fa fa-eye"> View</span>', (array('class' => 'btn btn-xs btn-info '))) ?> 
                                        </td>
                                    </tr>
