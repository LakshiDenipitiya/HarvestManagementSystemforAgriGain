...
//-------------------------------------------------------------------------------------------
   ...
   //--------------------------buyer_agreed status view controller-----------------
            ...
            $data['done_so'] = $this->Manageorderstatus_Model->get_both_agreed_so();
...
//---------------------------------due payment----------------------------
            ...
            $data['readytodistpatch_so_bo'] = $this->Manageorderstatus_Model->get_readytodistpatch_so_bo();
         ...
         function viewsupplyigorderstatus(){
            ...
            $data['bo_details']  = $this->Manageorderstatus_Model->get_so($boid);
            $data['bo_so_details'] = $this->Manageorderstatus_Model->get_full_so_bo_details($boid);
